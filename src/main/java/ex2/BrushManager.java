...
public class BrushManager {
    ...
    public Brush getBrush(String brushId){
        return this.brushes.stream().filter(b -> b.getId().equals(brushId)).findAny().get();
    }
    ...
    public static class Brush {
        ...
        public Brush(final String id, final int x, final int y, final int color) {
            this.id = id;
            this.x = x;
            this.y = y;
            this.color = color;
